    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-16 md:py-24">
        <div className="workloop-container text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 animate-fade-in">
            ...
            <br /> 
            <span className="text-workloop-purple">for Creatives</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 animate-fade-in" style={{animationDelay: "0.2s"}}>
            <Link to="/login?tab=register">
              <Button size="lg" className="bg-workloop-purple hover:bg-workloop-dark-purple gap-2">
                Get Started Free
                <ArrowRight size={16} />
              </Button>
            </Link>
      ...
      <section id="features" className="py-16 bg-secondary/50">
        <div className="workloop-container">
          <h2 className="text-3xl font-bold text-center mb-12">Powerful Features for Creatives</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="w-12 h-12 bg-workloop-purple/10 rounded-lg flex items-center justify-center mb-4">
                  <feature.icon size={24} className="text-workloop-purple" />
                </div>
      ...
      <section id="how-it-works" className="py-16">
        <div className="workloop-container">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.step} className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-full bg-workloop-purple/10 flex items-center justify-center mb-4 border-2 border-workloop-purple">
                  <span className="text-2xl font-bold text-workloop-purple">{item.step}</span>
                </div>
          ...
          <div className="mt-16 text-center">
            <Link to="/login?tab=register">
              <Button size="lg" className="bg-workloop-purple hover:bg-workloop-dark-purple">
